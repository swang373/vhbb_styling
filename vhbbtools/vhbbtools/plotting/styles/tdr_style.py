...
class TDRStyle(Style):
    """The CMS Technical Design Report (TDR) plotting style. Unused
    styling options from the original definition have been removed.
    """
    def __init__(self):
    ...
    def __enter__(self):
        ...
        """
        self.old_gStyle = get_style(ROOT.gStyle.GetName())
        set_style(self)
        return self

    def __exit__(self, exception_type, exception_value, traceback):
        """Override the __exit__ method to reset to the old gStyle.
        """
